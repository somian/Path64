...
#ifndef __pmp_stack_h
#define __pmp_stack_h

extern void __pmp_catch_segv (void);

extern int  __pmp_get_stack_size_limit (const char *new_limit,
                                        long long *max_stack_ptr,
                                        int nthreads);
