...
#ifndef __pmp_manager_h
#define __pmp_manager_h

extern void __pmp_manager_init (void);
extern void __pmp_manager_fini (void);
extern void __pmp_manager_create_main_thread (void);
extern int  __pmp_manager_create_more_threads (int nthreads);
