...
static const char USMID[] = "@(#) libu/util/i3e/ieee_next_after_d_h.c	92.0	10/08/98 14:57:41";
...
extern long double _IEEE_NEXT_AFTER_D_H(long double x, float y);
 ...
 *
 */
#pragma _CRI duplicate _IEEE_NEXT_AFTER_D_H as _IEEE_NEXT_AFTER_16_4
long double
_IEEE_NEXT_AFTER_D_H(long double x, float y)
{
