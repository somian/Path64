...
#ifndef KEY /* Bug 11640 */
/* Moved this to date_and_time.c since that code uses gettimeofday() for
 * resolution greater than one second, does DST-related magic, and
 * knows that Linux gettimeofday() generates an unreliable timezone
 */
