...
#pragma ident "@(#) libf/fort/bndchk.c	92.1	06/24/99 10:18:36"
#include <fortran.h>
#include <liberrno.h>
...
void
$BNDCHK(_fcd arrayname, int *index, int *linenum)
{
	int	len;
	...
	(void) _fwarn(FWBNDCHK, *linenum, name, *index, _fcdlen(arrayname),
			_fcdtocp(arrayname));
