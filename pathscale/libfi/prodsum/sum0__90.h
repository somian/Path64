...
CDIR$ ID "@(#) libfi/prodsum/sum0__90.h	92.0	10/08/98 14:37:14"
*********************************************************************
*                                                                   *
*  Name:   SUM0__90.h                                               *
*                                                                   *
...
*                                                                   *
*     dv_dim       Dope Vector (optional), describing the           *
...
*	.. arguments ..
	...
	integer dv_dim(*)	! dimension on which to sum
...
*
	call _PRE_SUM(0, dummy, dv_array, dv_dim, dv_mask,
