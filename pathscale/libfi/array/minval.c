...
/*
 *	MINVAL has six entry points.  There is an entry point for a dope
 *	vector return, and a scalar return for integer, real and double
 *	precision.
 */

/* P.E. 2.0 and earlier entry points for MINVAL contain only a single
 * underbar after MINVAL and before the TYPE letter.  Only these entry
 * points may specify DVSUBTYPE_INT46 and INTEGER(KIND=6).  P.E. 3.0
 * does not have INTEGER(KIND=6).
 *
 * P.E. 3.0 uses the double underbar between MINVAL and the TYPE letter.
...
#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL_J as MINVAL_J@
#endif
void
_MINVAL_J (	DopeVectorType	* result,
		DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	void __minval();
	(void) __minval (result, source, dimp, mask, 0, DVSUBTYPE_INT64,
		USE_INT8);
}

void
_MINVAL__J (	DopeVectorType	* result,
		DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	...
	_f_int dimenlc	= 0;
	LOAD_DM_MK();
	(void) __minval (result, source, dimenp, mk, 0, DVSUBTYPE_INT64,
		USE_INT8);
}


#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL_S as MINVAL_S@
#endif
void
_MINVAL_S (	DopeVectorType	* result,
		DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	void __minval();
	(void) __minval (result, source, dimp, mask, 0, DVSUBTYPE_REAL64,
		USE_REAL8);
}

void
_MINVAL__S (	DopeVectorType	* result,
		DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	...
	_f_int dimenlc	= 0;
	LOAD_DM_MK();
	(void) __minval (result, source, dimenp, mk, 0, DVSUBTYPE_REAL64,
		USE_REAL8);
}

#if defined _F_REAL16 && _F_REAL16 != (-1)
#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL_D as MINVAL_D@
#endif
void
_MINVAL_D (	DopeVectorType	* result,
		DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	void __minval();
	(void) __minval (result, source, dimp, mask, 0, DVSUBTYPE_REAL128,
		USE_REAL16);
}

void
_MINVAL__D (	DopeVectorType	* result,
		DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	...
	_f_int dimenlc	= 0;
	LOAD_DM_MK();
	(void) __minval (result, source, dimenp, mk, 0, DVSUBTYPE_REAL128,
		USE_REAL16);
}
#endif

#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL_I as MINVAL_I@
#endif
void
_MINVAL_I (	DopeVectorType	* result,
		DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	void __minval();
#ifdef	_F_INT6
	(void) __minval (result, source, dimp, mask, 0, DVSUBTYPE_INT46,
		USE_INT6);
#else
	(void) __minval (result, source, dimp, mask, 0, DVSUBTYPE_INT64,
		USE_INT8);
...
void
_MINVAL__I (	DopeVectorType	* result,
		DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	...
	LOAD_DM_MK();
#ifdef	_F_INT6
	(void) __minval (result, source, dimenp, mk, 0, DVSUBTYPE_INT46,
		USE_INT6);
#else
	(void) __minval (result, source, dimenp, mk, 0, DVSUBTYPE_INT64,
		USE_INT8);
...
#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL0_I as MINVAL0_I@
#endif
_f_int6
_MINVAL0_I (	DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
	...
	res_ptr->orig_size = 0;
#ifdef	_F_INT6
	__minval (res_ptr, source, dimp, mask, 1, DVSUBTYPE_INT46,
		USE_INT6);
#else
	(void) __minval (res_ptr, source, dimp, mask, 0, DVSUBTYPE_INT64,
		USE_INT8);
#endif
...
_f_int8
_MINVAL0__I (	DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
	...
	res_ptr->orig_size = 0;
#ifdef	_F_INT6
	__minval (res_ptr, source, dimenp, mk, 1, DVSUBTYPE_INT46,
		USE_INT6);
#else
	(void) __minval (res_ptr, source, dimenp, mk, 0, DVSUBTYPE_INT64,
		USE_INT8);
#endif
	return (*(_f_int6 *) res_ptr->base_addr.a.ptr);
}
...
#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL_I4 as MINVAL_I4@
#endif
void
_MINVAL_I4 (	DopeVectorType	* result,
		DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	...
	(void) __minval (result, source, dimp, mask, 0, DVSUBTYPE_INT46,
		USE_INT4);
#else
	(void) __minval (result, source, dimp, mask, 0, DVSUBTYPE_INT32,
		USE_INT4);
#endif
}

void
_MINVAL__I4 (	DopeVectorType	* result,
		DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	...
	(void) __minval (result, source, dimenp, mk, 0, DVSUBTYPE_INT46,
		USE_INT4);
#else
	(void) __minval (result, source, dimenp, mk, 0, DVSUBTYPE_INT32,
		USE_INT4);
#endif
}

#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL_I2 as MINVAL_I2@
#endif
void
_MINVAL_I2 (	DopeVectorType	* result,
		DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
...
void
_MINVAL__I2 (	DopeVectorType	* result,
		DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
...
#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL_I1 as MINVAL_I1@
#endif
void
_MINVAL_I1 (	DopeVectorType	* result,
		DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
...
void
_MINVAL__I1 (	DopeVectorType	* result,
		DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
...
#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL0_I4 as MINVAL0_I4@
#endif
_f_int4
_MINVAL0_I4 (	DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
	...
	__minval (res_ptr, source, dimp, mask, 1, DVSUBTYPE_INT46,
		USE_INT4);
#else
	__minval (res_ptr, source, dimp, mask, 1, DVSUBTYPE_INT32,
		USE_INT4);
#endif
...
_f_int4
_MINVAL0__I4 (	DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
	...
	__minval (res_ptr, source, dimenp, mk, 1, DVSUBTYPE_INT46,
		USE_INT4);
#else
	__minval (res_ptr, source, dimenp, mk, 1, DVSUBTYPE_INT32,
		USE_INT4);
#endif
	return (*(_f_int4 *) res_ptr->base_addr.a.ptr);
}
...
#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL0_I2 as MINVAL0_I2@
#endif
_f_int2
_MINVAL0_I2 (	DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
...
_f_int2
_MINVAL0__I2 (	DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
...
#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL0_I1 as MINVAL0_I1@
#endif
_f_int1
_MINVAL0_I1 (	DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
...
_f_int1
_MINVAL0__I1 (	DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
...
#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL_S4 as MINVAL_S4@
#endif
void
_MINVAL_S4 (	DopeVectorType	* result,
		DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	...
	(void) __minval (result, source, dimp, mask, 0, DVSUBTYPE_REAL64,
		USE_REAL4);
#else
	(void) __minval (result, source, dimp, mask, 0, DVSUBTYPE_REAL32,
		USE_REAL4);
#endif
}

void
_MINVAL__S4 (	DopeVectorType	* result,
		DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	...
	(void) __minval (result, source, dimenp, mk, 0, DVSUBTYPE_REAL64,
		USE_REAL4);
#else
	(void) __minval (result, source, dimenp, mk, 0, DVSUBTYPE_REAL32,
		USE_REAL4);
#endif
}

#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL0_S4 as MINVAL0_S4@
#endif
_f_real4
_MINVAL0_S4 (	DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
	...
	res_ptr->orig_size = 0;
#ifndef	_F_REAL4
	__minval (res_ptr, source, dimp, mask, 1, DVSUBTYPE_REAL64,
		USE_REAL4);
#else
	__minval (res_ptr, source, dimp, mask, 1, DVSUBTYPE_REAL32,
		USE_REAL4);
#endif
...
_f_real4
_MINVAL0__S4 (	DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
	...
	res_ptr->orig_size = 0;
#ifndef	_F_REAL4
	__minval (res_ptr, source, dimenp, mk, 1, DVSUBTYPE_REAL64,
		USE_REAL4);
#else
...
#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL0_J as MINVAL0_J@
#endif
_f_int8
_MINVAL0_J (	DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
	...
	res_ptr->orig_size = 0;
	__minval (res_ptr, source, dimp, mask, 1, DVSUBTYPE_INT64,
		USE_INT8);
	return(*(_f_int8 *) res_ptr->base_addr.a.ptr);
}

_f_int8
_MINVAL0__J (	DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
	...
	res_ptr->orig_base = (_f_int8 *) NULL;
	res_ptr->orig_size = 0;
	__minval (res_ptr, source, dimenp, mk, 1, DVSUBTYPE_INT64,
		USE_INT8);
	return(*(_f_int8 *) res_ptr->base_addr.a.ptr);
}

#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL0_S as MINVAL0_S@
#endif
_f_real8
_MINVAL0_S (	DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
...
_f_real8
_MINVAL0__S (	DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
...
#if defined _F_REAL16 && _F_REAL16 != (-1)
#ifdef _UNICOS
#pragma _CRI duplicate _MINVAL0_D as MINVAL0_D@
#endif
_f_real16
_MINVAL0_D (	DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
	...
	res_ptr->orig_size = 0;
	__minval (res_ptr, source, dimp, mask, 1, DVSUBTYPE_REAL128,
		USE_REAL16);
	return(*(_f_real16 *) res_ptr->base_addr.a.ptr);
}

_f_real16
_MINVAL0__D (	DopeVectorType	* source,
		DopeVectorType	* dimp,
		DopeVectorType	* mask)
{
	void		__minval();
	...
	res_ptr->orig_base = (_f_real16 *) NULL;
	res_ptr->orig_size = 0;
	__minval (res_ptr, source, dimenp, mk, 1, DVSUBTYPE_REAL128,
		USE_REAL16);
	return(*(_f_real16 *) res_ptr->base_addr.a.ptr);
}
#endif
...
void
__minval (	DopeVectorType	* result,
		DopeVectorType	* source,
		_f_int		* dimp,
		DopeVectorType	* mask,
		int		scalar,
 ...
 */
	...
	if (rank == 1) {
		...
		case DVSUBTYPE_INT46 :
		    i6ptr2 = (_f_int6 *) rptr;
		    if (init_val == USE_INT6)
			cur_mini = HUGE_INT6_F90;
		    else if (init_val == USE_INT4)
			cur_mini = HUGE_INT4_F90;
		    else if (init_val == USE_INT2)
			cur_mini = HUGE_INT2_F90;
		    else
			cur_mini = HUGE_INT1_F90;
		    use_int6 = cur_mini;
		    if (use_mask) {
			i6ptr1 = (_f_int6 *) sptr;
			lptr = (_f_mask *) mptr;
			for (i = 0; i < src_ext[ndim]; i++) {
				...
				if (LTOB(mask_el_len, &lptr[mindx])) {
				    ...
				    if (i6ptr1[sindx] < cur_mini)
					cur_mini = i6ptr1[sindx];
				}
			    }
			    if (!scalar) {
				rindx = i * res_strd[0];
				i6ptr2[rindx] = cur_mini;
				cur_mini = use_int6;
			    }
			}
		    } else {
		...
		case DVSUBTYPE_INT32 :
		    i4ptr2 = (_f_int4 *) rptr;
		    if (init_val == USE_INT4)
			cur_mini4 = HUGE_INT4_F90;
		    else if (init_val == USE_INT2)
			cur_mini4 = HUGE_INT2_F90;
		    else
			cur_mini4 = HUGE_INT1_F90;
		    use_int4 = cur_mini4;
		    if (use_mask) {
			i4ptr1 = (_f_int4 *) sptr;
			lptr = (_f_mask *) mptr;
			...
			for (i = 0; i < src_ext[ndim]; i++) {
				...
				if (LTOB(mask_el_len, &lptr[mindx])) {
				    sindx = indx1_src + (j * src_strd[dim]);
				    if (!first) {
					if ((i4ptr1[sindx]^cur_mini4) >= 0) {
					    if (i4ptr1[sindx] < cur_mini4)
						cur_mini4 = i4ptr1[sindx];
					} else {
					    if (i4ptr1[sindx] < 0)
						cur_mini4 = i4ptr1[sindx];
					}
		...
		case DVSUBTYPE_INT64 :
			...
			for (i = 0; i < src_ext[ndim]; i++) {
				...
				if (LTOB(mask_el_len, &lptr[mindx])) {
				    sindx = indx1_src + (j * src_strd[dim]);
				    if (!first) {
					if ((i8ptr1[sindx]^cur_minj) >= 0) {
					    if (i8ptr1[sindx] < cur_minj)
						cur_minj = i8ptr1[sindx];
					} else {
					    if (i8ptr1[sindx] < 0)
						cur_minj = i8ptr1[sindx];
					}
		...
		case DVSUBTYPE_REAL64 :
		    r8ptr2 = (_f_real8 *) rptr;
		    if (init_val == USE_REAL8)
			cur_minf = HUGE_REAL8_F90;
		    else
			cur_minf = HUGE_REAL4_F90;
		    use_flt8 = cur_minf;
		    if (use_mask) {
			r8ptr1 = (_f_real8 *) sptr;
			lptr = (_f_mask *) mptr;
			for (i = 0; i < src_ext[ndim]; i++) {
				...
				if (LTOB(mask_el_len, &lptr[mindx])) {
				    sindx = indx1_src + (j * src_strd[dim]);
				    if (r8ptr1[sindx] < cur_minf)
					cur_minf = r8ptr1[sindx];
				}
			    }
			    if (!scalar) {
				rindx = i * res_strd[0];
				r8ptr2[rindx] = cur_minf;
				cur_minf = use_flt8;
			    }
			}
		    } else {
		...
		case DVSUBTYPE_REAL32 :
			...
			for (i = 0; i < src_ext[ndim]; i++) {
				...
				if (LTOB(mask_el_len, &lptr[mindx])) {
				    sindx = indx1_src + (j * src_strd[dim]);
				    if (r4ptr1[sindx] < cur_mins4)
					cur_mins4 = r4ptr1[sindx];
				}
			    }
			    if (!scalar) {
				rindx = i * res_strd[0];
				r4ptr2[rindx] = cur_mins4;
				cur_mins4 = HUGE_REAL4_F90;
			    }
			}
		    } else {
		...
		case DVSUBTYPE_REAL128 :
			...
			for (j = 0; j < src_ext[dim]; j++) {
				...
				if (LTOB(mask_el_len, &lptr[mindx])) {
				    sindx = indx1_src + (j * src_strd[dim]);
				    if (r16ptr1[sindx] < cur_mind)
					cur_mind = r16ptr1[sindx];
				}
			    } else {
				sindx = indx1_src + (j * src_strd[dim]);
				if (r16ptr1[sindx] < cur_mind)
