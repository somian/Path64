...
/*
 * Maxloc function.  Determine the location of the first element of an array
 * having the maximum value of the elements identified by a mask variable.
 */

/* P.E. 2.0 and earlier entry points for MAXLOC contain only a single
 * underbar after MAXLOC and before the TYPE letter.  Only these entry
 * points may specify DVSUBTYPE_INT46 and INTEGER(KIND=6).  P.E. 3.0
 * does not have INTEGER(KIND=6).
 *
 * P.E. 3.0 uses the double underbar between MAXLOC and the TYPE letter.
 ...
 */
#ifdef _UNICOS
#pragma	_CRI duplicate _MAXLOC_I4 as MAXLOC_I4@
#endif
void
_MAXLOC_I4(	DopeVectorType	* result,	/* integer-32		*/
		...
		DopeVectorType	* mask)
{
	...
	_f_int	dimension = 0;
#ifndef	_F_INT4
	(void) __maxloc (result, source, dimension, mask, DVSUBTYPE_INT46);
#else
	(void) __maxloc (result, source, dimension, mask, DVSUBTYPE_INT32);
#endif
}

void
_MAXLOC__I4(	DopeVectorType	* result,	/* integer-32		*/
		DopeVectorType	* source,
		...
		DopeVectorType	* mask)
{
	...
	_LOAD_DM_MK();
#ifndef	_F_INT4
	(void) __maxloc (result, source, dm, mk, DVSUBTYPE_INT46);
#else
	(void) __maxloc (result, source, dm, mk, DVSUBTYPE_INT32);
#endif
}

void
_MAXLOC_I2(	DopeVectorType	* result,	/* integer-16		*/
		DopeVectorType	* source,
		DopeVectorType	* mask)
{
	void __maxloc();
...
void
_MAXLOC__I2(	DopeVectorType	* result,	/* integer-16		*/
		DopeVectorType	* source,
		DopeVectorType	* dimension,
		DopeVectorType	* mask)
{
	...
	_LOAD_DM_MK();
#if	defined(_F_INT2)
	(void) __maxloc (result, source, dm, mk, DVSUBTYPE_BIT16);
...
void
_MAXLOC_I1(	DopeVectorType	* result,	/* integer-8		*/
		DopeVectorType	* source,
		DopeVectorType	* mask)
{
	void __maxloc();
...
void
_MAXLOC__I1(	DopeVectorType	* result,	/* integer-8		*/
		DopeVectorType	* source,
		DopeVectorType	* dimension,
		DopeVectorType	* mask)
{
	...
	_LOAD_DM_MK();
#if	defined(_F_INT1)
	(void) __maxloc (result, source, dm, mk, DVSUBTYPE_BIT8);
#elif	!defined(_F_INT4)
	(void) __maxloc (result, source, dm, mk, DVSUBTYPE_INT46);
#else
	(void) __maxloc (result, source, dm, mk, DVSUBTYPE_INT32);
...
#ifdef _UNICOS
#pragma	_CRI duplicate _MAXLOC_I as MAXLOC_I@
#endif
void
_MAXLOC_I(	DopeVectorType	* result,	/* integer-46		*/
		DopeVectorType	* source,
		DopeVectorType	* mask)
{
	void __maxloc();
	...
	(void) __maxloc (result, source, dimension, mask, DVSUBTYPE_INT46);
#else
	(void) __maxloc (result, source, dimension, mask, DVSUBTYPE_INT64);
#endif
}

void
_MAXLOC__I(	DopeVectorType	* result,	/* integer-46		*/
		DopeVectorType	* source,
		DopeVectorType	* dimension,
		DopeVectorType	* mask)
{
	...
	(void) __maxloc (result, source, dm, mk, DVSUBTYPE_INT46);
#else
	(void) __maxloc (result, source, dm, mk, DVSUBTYPE_INT64);
#endif
}

#ifdef _UNICOS
#pragma	_CRI duplicate _MAXLOC_J as MAXLOC_J@
#endif
void
_MAXLOC_J(	DopeVectorType	* result,	/* integer-64		*/
		DopeVectorType	* source,
		DopeVectorType	* mask)
{
	void __maxloc();
...
void
_MAXLOC__J(	DopeVectorType	* result,	/* integer-64		*/
		DopeVectorType	* source,
		DopeVectorType	* dimension,
		DopeVectorType	* mask)
{
...
#ifdef _UNICOS
#pragma	_CRI duplicate _MAXLOC_S as MAXLOC_S@
#endif
void
_MAXLOC_S(	DopeVectorType	* result,	/* 64-bit real		*/
		DopeVectorType	* source,
		DopeVectorType	* mask)
{
	void __maxloc();
	_f_int	dimension = 0;
	(void) __maxloc (result, source, dimension, mask, DVSUBTYPE_REAL64);
}

void
_MAXLOC__S(	DopeVectorType	* result,	/* 64-bit real		*/
		DopeVectorType	* source,
		DopeVectorType	* dimension,
		DopeVectorType	* mask)
{
	...
	DopeVectorType	*dm, *mk;
	_LOAD_DM_MK();
	(void) __maxloc (result, source, dm, mk, DVSUBTYPE_REAL64);
}

#if defined _F_REAL16 && _F_REAL16 != (-1)
#ifdef _UNICOS
#pragma	_CRI duplicate _MAXLOC_D as MAXLOC_D@
#endif
void
_MAXLOC_D(	DopeVectorType	* result,	/* 128-bit real		*/
		DopeVectorType	* source,
		DopeVectorType	* mask)
{
	void __maxloc();
	_f_int	dimension = 0;
	(void) __maxloc (result, source, dimension, mask, DVSUBTYPE_REAL128);
}

void
_MAXLOC__D(	DopeVectorType	* result,	/* 128-bit real		*/
		DopeVectorType	* source,
		DopeVectorType	* dimension,
		DopeVectorType	* mask)
{
	...
	DopeVectorType	*dm, *mk;
	_LOAD_DM_MK();
	(void) __maxloc (result, source, dm, mk, DVSUBTYPE_REAL128);
}
#endif


#ifdef _UNICOS
#pragma	_CRI duplicate _MAXLOC_S4 as MAXLOC_S4@
#endif
void
_MAXLOC_S4(	DopeVectorType	* result,	/* 32-bit real		*/
		DopeVectorType	* source,
		DopeVectorType	* mask)
{
	void __maxloc();
	...
	(void) __maxloc (result, source, dimension, mask, DVSUBTYPE_REAL64);
#else
	(void) __maxloc (result, source, dimension, mask, DVSUBTYPE_REAL32);
#endif
}

void
_MAXLOC__S4(	DopeVectorType	* result,	/* 32-bit real		*/
		DopeVectorType	* source,
		DopeVectorType	* dimension,
		DopeVectorType	* mask)
{
	...
	(void) __maxloc (result, source, dm, mk, DVSUBTYPE_REAL64);
#else
	(void) __maxloc (result, source, dm, mk, DVSUBTYPE_REAL32);
#endif
}
...
void
__maxloc (	DopeVectorType	* result,
		DopeVectorType	* source,
		DopeVectorType	* dimension,
		DopeVectorType	* mask,
		_f_int		subtype)
 ...
 *	is compared against the current maximum value.  If the source value
 ...
 *	that no maximum has yet been found.  The actual return values are
 *	set at the end of the loop.  If all values of mask are false, then
 *	these values are returned to indicate that no maximum value was
 *	found.
 */
	if (rank == 1) {
