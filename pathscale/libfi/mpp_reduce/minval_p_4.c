...
#pragma ident "@(#) libfi/mpp_reduce/minval_p_4.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _MINVAL_JP4(RESULT, SOURCE, DIM, MASK)
 *				 CALL _MINVAL_SP4(RESULT, SOURCE, DIM, MASK)
 *
