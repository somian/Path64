...
#pragma ident "@(#) libfi/mpp_reduce/prod_s_5.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _PROD_JS5(RESULT, SOURCE, DIM, MASK)
 *				 CALL _PROD_SS5(RESULT, SOURCE, DIM, MASK)
 *
 ...
 *	         arrays of rank 5 with a data type of 64-bit integer
 ...
 *
 *	Description:
 *		This is the MPP single PE version of PRODUCT. This
 ...
 *
 *		Include file prod_s.h contains the rank independent
