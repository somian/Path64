...
#pragma ident "@(#) libfi/mpp_reduce/prod_s_2.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _PROD_JS2(RESULT, SOURCE, DIM, MASK)
 *				 CALL _PROD_SS2(RESULT, SOURCE, DIM, MASK)
 *
 ...
 *	         arrays of rank 2 with a data type of 64-bit integer
