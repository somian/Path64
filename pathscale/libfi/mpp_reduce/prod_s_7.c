...
#pragma ident "@(#) libfi/mpp_reduce/prod_s_7.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _PROD_JS7(RESULT, SOURCE, DIM, MASK)
 *				 CALL _PROD_SS7(RESULT, SOURCE, DIM, MASK)
 *
 ...
 *	         arrays of rank 7 with a data type of 64-bit integer
