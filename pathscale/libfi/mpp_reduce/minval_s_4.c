...
#pragma ident "@(#) libfi/mpp_reduce/minval_s_4.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _MINVAL_JS4(RESULT, SOURCE, DIM, MASK)
 *				 CALL _MINVAL_SS4(RESULT, SOURCE, DIM, MASK)
 *
