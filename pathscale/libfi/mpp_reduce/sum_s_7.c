...
#pragma ident "@(#) libfi/mpp_reduce/sum_s_7.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _SUM_JS7(RESULT, SOURCE, DIM, MASK)
 *				 CALL _SUM_SS7(RESULT, SOURCE, DIM, MASK)
 *
