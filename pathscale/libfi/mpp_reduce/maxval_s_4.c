...
#pragma ident "@(#) libfi/mpp_reduce/maxval_s_4.c	92.1	07/09/99 17:05:42"
...
/*
 *	Compiler generated call: CALL _MAXVAL_JS4(RESULT, SOURCE, DIM, MASK)
 *				 CALL _MAXVAL_SS4(RESULT, SOURCE, DIM, MASK)
 *
