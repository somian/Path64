...
#pragma ident "@(#) libfi/mpp_reduce/count_s_5.c	92.1	07/09/99 17:05:42"
...
/*
 *	Compiler generated call: CALL _COUNT_LS5(RESULT, SOURCE, DIM)
 *
 *	Purpose: Count the number of true elements in SOURCE along
 *	         dimension DIM. This particular routine handles
 *		 source arrays of rank 5.
 *
 *	Arguments:
 *	        SOURCE - Dope vector for integer source array
 *	        DIM    - Dimension to operate along
 *
 *      Description:
 *		This is the MPP version of COUNT. This particular
 ...
 *		processors.
 *
 *		Include file count_s.h contains the rank independent
