...
#pragma ident "@(#) libfi/mpp_reduce/minval_p_2.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _MINVAL_JP2(RESULT, SOURCE, DIM, MASK)
 *				 CALL _MINVAL_SP2(RESULT, SOURCE, DIM, MASK)
 *
