...
#pragma ident "@(#) libfi/mpp_reduce/maxval_p_4.c	92.1	07/09/99 17:05:42"
...
/*
 *	Compiler generated call: CALL _MAXVAL_JP4(RESULT, SOURCE, DIM, MASK)
 *				 CALL _MAXVAL_SP4(RESULT, SOURCE, DIM, MASK)
 *
