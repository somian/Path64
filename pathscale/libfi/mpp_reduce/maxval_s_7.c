...
#pragma ident "@(#) libfi/mpp_reduce/maxval_s_7.c	92.1	07/09/99 17:05:42"
...
/*
 *	Compiler generated call: CALL _MAXVAL_JS7(RESULT, SOURCE, DIM, MASK)
 *				 CALL _MAXVAL_SS7(RESULT, SOURCE, DIM, MASK)
 *
