...
#pragma ident "@(#) libfi/mpp_reduce/sum_s_3.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _SUM_JS3(RESULT, SOURCE, DIM, MASK)
 *				 CALL _SUM_SS3(RESULT, SOURCE, DIM, MASK)
 *
