...
#pragma ident "@(#) libfi/mpp_reduce/any_s_4.c	92.1	07/09/99 17:05:42"
...
/*
 *	Compiler generated call: CALL _ANY_LS4(RESULT, SOURCE, DIM)
 *
 ...
 *		processors.
 *
 *		Include file any_s.h contains the rank independent
