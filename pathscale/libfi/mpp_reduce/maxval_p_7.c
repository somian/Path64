...
#pragma ident "@(#) libfi/mpp_reduce/maxval_p_7.c	92.1	07/09/99 17:05:42"
...
/*
 *	Compiler generated call: CALL _MAXVAL_JP7(RESULT, SOURCE, DIM, MASK)
 *				 CALL _MAXVAL_SP7(RESULT, SOURCE, DIM, MASK)
 *
