...
#pragma ident "@(#) libfi/mpp_reduce/sum_p_5.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _SUM_JP5(RESULT, SOURCE, DIM, MASK)
 *				 CALL _SUM_SP5(RESULT, SOURCE, DIM, MASK)
 *
