...
#pragma ident "@(#) libfi/mpp_reduce/prod_p_2.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _PROD_JP2(RESULT, SOURCE, DIM, MASK)
 *				 CALL _PROD_SP2(RESULT, SOURCE, DIM, MASK)
 *
