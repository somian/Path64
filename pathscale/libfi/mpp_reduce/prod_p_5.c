...
#pragma ident "@(#) libfi/mpp_reduce/prod_p_5.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _PROD_JP5(RESULT, SOURCE, DIM, MASK)
 *				 CALL _PROD_SP5(RESULT, SOURCE, DIM, MASK)
 *
