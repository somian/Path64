...
/* USMID @(#) libfi/mpp_reduce/any_s.h	92.0	10/08/98 14:37:14 */
...
void
XGLUE(_ANY_LS,RANK)(DopeVectorType * result,
	 ...
	 long * dim)
{
	...
	if (!_is_shared_pointer(source->base_addr.a.ptr)) {
	    ...
	    XGLUE(XGLUE(ANY_I_LS,RANK),@)(result_base_ptr, source_sdd_ptr,
