...
#pragma ident "@(#) libfi/mpp_reduce/prod_s_6.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _PROD_JS6(RESULT, SOURCE, DIM, MASK)
 *				 CALL _PROD_SS6(RESULT, SOURCE, DIM, MASK)
 *
