...
#pragma ident "@(#) libfi/mpp_reduce/maxval_p_2.c	92.1	07/09/99 17:05:42"
...
/*
 *	Compiler generated call: CALL _MAXVAL_JP2(RESULT, SOURCE, DIM, MASK)
 *				 CALL _MAXVAL_SP2(RESULT, SOURCE, DIM, MASK)
 *
 ...
 *
 *      Description:
 *		This is the MPP version of MAXVAL. This particular
 ...
 *		processors.
 *
 *		Include file maxval_p.h contains the rank independent
