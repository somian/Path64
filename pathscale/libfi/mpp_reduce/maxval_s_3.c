...
#pragma ident "@(#) libfi/mpp_reduce/maxval_s_3.c	92.1	07/09/99 17:05:42"
...
/*
 *	Compiler generated call: CALL _MAXVAL_JS3(RESULT, SOURCE, DIM, MASK)
 *				 CALL _MAXVAL_SS3(RESULT, SOURCE, DIM, MASK)
 *
