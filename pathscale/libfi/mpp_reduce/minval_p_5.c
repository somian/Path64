...
#pragma ident "@(#) libfi/mpp_reduce/minval_p_5.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _MINVAL_JP5(RESULT, SOURCE, DIM, MASK)
 *				 CALL _MINVAL_SP5(RESULT, SOURCE, DIM, MASK)
 *
