...
#pragma ident "@(#) libfi/mpp_reduce/prod_p_6.c	92.1	07/09/99 17:07:39"
...
/*
 *	Compiler generated call: CALL _PROD_JP6(RESULT, SOURCE, DIM, MASK)
 *				 CALL _PROD_SP6(RESULT, SOURCE, DIM, MASK)
 *
