...
#pragma ident "@(#) libfi/mpp_pre/premax_sp_7.c	92.1	07/09/99 15:35:58"
...
/*
 *	Compiler generated call: CALL _PREMAX_SP7(RESULT, SOURCE, DIM, MASK)
 *
...
void
_PREMAX_SP7 (	DopeVectorType	*result,
...
#include "parallel_prefix_p.h"
	...
	if (mask_flag == 1)
	    PREMAX_MASK_SP7@ (result_sdd_ptr, source_sdd_ptr, &dim_val,
		mask_sdd_ptr, src_extents, blkcnts);
	else
	    PREMAX_NOMASK_SP7@ (result_sdd_ptr, source_sdd_ptr, &dim_val,
		src_extents, blkcnts);
