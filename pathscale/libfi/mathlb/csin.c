...
#pragma ident "@(#) libfi/mathlb/csin.c	92.1	07/09/99 11:00:36"
...
extern void _CSIN(c_complex_t *ret_val, c_complex_t z);
extern void _CSIN_(c_complex_t *ret_val, c_complex_t *z);
...
/*
 * CSIN - complex(kind=8) - pass by address
 */
void
_CSIN_(c_complex_t *ret_val,
	c_complex_t *z)
{
	_CSIN(ret_val, *z);
}
