...
#pragma ident "@(#) libfi/mathlb/fp_class_d.c	92.2	08/02/99 13:59:36"
...
extern _f_int4 _FP_CLASS_I4_D(_f_real16 x);

/* Argument:  128-bit real
...
extern _f_int8 _FP_CLASS_I8_D(_f_real16 x);

/* Argument:  128-bit real
 * Result:    64-bit integer
 */

_f_int8 _FP_CLASS_I8_D(_f_real16 x)
{
#if defined(__mips) || (defined(_LITTLE_ENDIAN) && defined(__sv2))
