...
static const char USMID[] = "@(#) libfi/mathlb/ieee_binary_scale_r_i.c	92.0	10/08/98 14:37:14";
...
extern _f_real8 _IEEE_BINARY_SCALE(_f_real8 orig_number,
   _f_int8 orig_scale_factor);
extern _f_real8 _IEEE_BINARY_SCALE_I8(_f_real8 orig_number,
   _f_int8 orig_scale_factor);
...
_f_real8
_IEEE_BINARY_SCALE(_f_real8 orig_number, _f_int8 orig_scale_factor)
{
	_f_real8 _IEEE_BINARY_SCALE_I8(_f_real8 orig_number,
				    _f_int8 orig_scale_factor);
	return(_IEEE_BINARY_SCALE_I8(orig_number, orig_scale_factor));
}
