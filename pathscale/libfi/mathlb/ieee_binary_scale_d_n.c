...
#pragma ident "@(#) libfi/mathlb/ieee_binary_scale_d_n.c	92.1	07/09/99 11:00:36"
...
extern _f_real16 _IEEE_BINARY_SCALE_D_I4(_f_real16 orig_number,
...
_f_real16
_IEEE_BINARY_SCALE_D_I4(_f_real16 orig_number, _f_int4 orig_scale_factor)
{
	union ldble_float {
		_f_real16		whole;
