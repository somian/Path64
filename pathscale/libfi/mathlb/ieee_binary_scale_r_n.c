...
#pragma ident "@(#) libfi/mathlb/ieee_binary_scale_r_n.c	92.1	07/09/99 11:00:36"
...
extern _f_real8 _IEEE_BINARY_SCALE_I4(_f_real8 orig_number,
   _f_int4 orig_scale_factor);
...
#ifndef __mips
#pragma _CRI duplicate _IEEE_BINARY_SCALE_I4 as _IEEE_BINARY_SCALE_R_I4
#endif
_f_real8
_IEEE_BINARY_SCALE_I4(_f_real8 orig_number, _f_int4 orig_scale_factor)
{
	int	lz, lzm, shift;
