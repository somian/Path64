...
#pragma ident "@(#) libfi/mathlb/ctoi.c	92.2	11/16/99 18:14:06"
...
extern void _CTOI(c_complex_t *ret_val, c_complex_t x, _f_int8 *y );

/*
 *	complex(kind=8) raised to an Integer*64 = _CTOI
 *
 *	x = a+b*i
 *
...
/* __powzi = a**n  */
dbl_complex_t
__powzl(_f_real8 arel, _f_real8 aimg, _f_int8 n)
{
