...
#pragma ident "@(#) libfi/mathlb/cdtoi.c	92.1	07/09/99 11:00:36"
...
extern void _CDTOI(d_complex_t *ret_val, d_complex_t x, _f_int8 *y );

/*
 *      complex(kind=16) raised to an Integer*64 = _CDTOI
 *
 *      x = a+b*i
 *
