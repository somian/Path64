...
#pragma ident "@(#) libfi/mpp_shift/eoshift_s_wd1_4.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _EOSHIFT_JS4(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_LS4(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_SS4(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *
...
#pragma duplicate _EOSHIFT_JS4 as _EOSHIFT_LS4
#pragma duplicate _EOSHIFT_JS4 as _EOSHIFT_SS4
 ...
 */
	    ...
	    EOSHIFT_WD1_S4@ ( result_base_ptr, source_sdd_ptr, shift_sdd_ptr,
