...
#pragma ident "@(#) libfi/mpp_shift/eoshift_p_wd1_6.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _EOSHIFT_JP6(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_LP6(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_SP6(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *
...
#pragma duplicate _EOSHIFT_JP6 as _EOSHIFT_LP6
#pragma duplicate _EOSHIFT_JP6 as _EOSHIFT_SP6
 ...
 */
	...
	EOSHIFT_WD1_P6@ ( result_sdd_ptr, source_sdd_ptr, shift_sdd_ptr,
