...
#pragma ident "@(#) libfi/mpp_shift/eoshift_s_wd1_1.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _EOSHIFT_JS1(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_LS1(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_SS1(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *
...
#pragma duplicate _EOSHIFT_JS1 as _EOSHIFT_LS1
#pragma duplicate _EOSHIFT_JS1 as _EOSHIFT_SS1
 ...
 */
	    ...
	    EOSHIFT_WD1_S1@ ( result_base_ptr, source_sdd_ptr, shft_array,
