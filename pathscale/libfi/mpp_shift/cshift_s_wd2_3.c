...
#pragma ident "@(#) libfi/mpp_shift/cshift_s_wd2_3.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _CSHIFT_CS3(RESULT, SOURCE, SHIFT, DIM)
 *
 ...
 */
	    ...
	    CSHIFT_WD2_S3@ ( result_base_ptr, source_sdd_ptr, shift_sdd_ptr,
