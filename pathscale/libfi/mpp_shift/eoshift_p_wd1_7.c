...
#pragma ident "@(#) libfi/mpp_shift/eoshift_p_wd1_7.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _EOSHIFT_JP7(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_LP7(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_SP7(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *
...
#pragma duplicate _EOSHIFT_JP7 as _EOSHIFT_LP7
#pragma duplicate _EOSHIFT_JP7 as _EOSHIFT_SP7
 ...
 */
	...
	EOSHIFT_WD1_P7@ ( result_sdd_ptr, source_sdd_ptr, shift_sdd_ptr,
