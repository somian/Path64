...
#pragma ident "@(#) libfi/mpp_shift/eoshift_s_wd2_1.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _EOSHIFT_CS1(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *
 ...
 */
	    ...
	    EOSHIFT_WD2_S1@ ( result_base_ptr, source_sdd_ptr, shft_array,
