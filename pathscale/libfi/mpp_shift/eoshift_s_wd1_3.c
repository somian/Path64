...
#pragma ident "@(#) libfi/mpp_shift/eoshift_s_wd1_3.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _EOSHIFT_JS3(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_LS3(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_SS3(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *
...
#pragma duplicate _EOSHIFT_JS3 as _EOSHIFT_LS3
#pragma duplicate _EOSHIFT_JS3 as _EOSHIFT_SS3
 ...
 */
	    ...
	    EOSHIFT_WD1_S3@ ( result_base_ptr, source_sdd_ptr, shift_sdd_ptr,
