...
#pragma ident "@(#) libfi/mpp_shift/cshift_p_wd1_2.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _CSHIFT_JP2(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_LP2(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_SP2(RESULT, SOURCE, SHIFT, DIM)
 *
...
#pragma duplicate _CSHIFT_JP2 as _CSHIFT_LP2
#pragma duplicate _CSHIFT_JP2 as _CSHIFT_SP2
 ...
 */
	...
	if (special) {
	    CSHIFT_SPEC_WD1_P2@ ( result_sdd_ptr, source_sdd_ptr,
		&dim_val, src_extents, &shftval);
	} else {
	    CSHIFT_WD1_P2@ ( result_sdd_ptr, source_sdd_ptr, shift_sdd_ptr,
