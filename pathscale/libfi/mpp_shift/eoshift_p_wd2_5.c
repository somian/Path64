...
#pragma ident "@(#) libfi/mpp_shift/eoshift_p_wd2_5.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _EOSHIFT_CP5(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *
 ...
 */
	...
	EOSHIFT_WD2_P5@ ( result_sdd_ptr, source_sdd_ptr, shift_sdd_ptr,
