...
#pragma ident "@(#) libfi/mpp_shift/eoshift_p_wd2_1.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _EOSHIFT_CP1(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *
 ...
 */
	...
	if (special) {
	    EOSHIFT_SPEC_WD2_P1@ ( result_sdd_ptr, source_sdd_ptr,
		&dim_val, src_extents, &shftval, &bndval);
	} else {
	    EOSHIFT_WD2_P1@ ( result_sdd_ptr, source_sdd_ptr, shft_array,
