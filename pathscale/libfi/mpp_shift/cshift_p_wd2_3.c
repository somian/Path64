...
#pragma ident "@(#) libfi/mpp_shift/cshift_p_wd2_3.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _CSHIFT_CP3(RESULT, SOURCE, SHIFT, DIM)
 *
 ...
 */
	...
	if (special) {
	    CSHIFT_SPEC_WD2_P3@ ( result_sdd_ptr, source_sdd_ptr,
		&dim_val, src_extents, &shftval);
	} else {
	    CSHIFT_WD2_P3@ ( result_sdd_ptr, source_sdd_ptr, shift_sdd_ptr,
