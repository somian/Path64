...
#pragma ident "@(#) libfi/mpp_shift/eoshift_s_wd1_2.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _EOSHIFT_JS2(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_LS2(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_SS2(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *
...
#pragma duplicate _EOSHIFT_JS2 as _EOSHIFT_LS2
#pragma duplicate _EOSHIFT_JS2 as _EOSHIFT_SS2
 ...
 */
	    ...
	    EOSHIFT_WD1_S2@ ( result_base_ptr, source_sdd_ptr, shift_sdd_ptr,
