...
#pragma ident "@(#) libfi/mpp_shift/cshift_p_wd1_1.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _CSHIFT_JP1(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_LP1(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_SP1(RESULT, SOURCE, SHIFT, DIM)
 *
...
#pragma duplicate _CSHIFT_JP1 as _CSHIFT_LP1
#pragma duplicate _CSHIFT_JP1 as _CSHIFT_SP1
