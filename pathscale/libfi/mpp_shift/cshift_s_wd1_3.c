...
#pragma ident "@(#) libfi/mpp_shift/cshift_s_wd1_3.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _CSHIFT_JS3(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_LS3(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_SS3(RESULT, SOURCE, SHIFT, DIM)
 *
...
#pragma duplicate _CSHIFT_JS3 as _CSHIFT_LS3
#pragma duplicate _CSHIFT_JS3 as _CSHIFT_SS3
 ...
 */
	    ...
	    CSHIFT_WD1_S3@ ( result_base_ptr, source_sdd_ptr, shift_sdd_ptr,
