...
#pragma ident "@(#) libfi/mpp_shift/cshift_p_wd1_6.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _CSHIFT_JP6(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_LP6(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_SP6(RESULT, SOURCE, SHIFT, DIM)
 *
...
#pragma duplicate _CSHIFT_JP6 as _CSHIFT_LP6
#pragma duplicate _CSHIFT_JP6 as _CSHIFT_SP6
 ...
 */
	...
	CSHIFT_WD1_P6@ ( result_sdd_ptr, source_sdd_ptr, shift_sdd_ptr,
