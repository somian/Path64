...
#pragma ident "@(#) libfi/mpp_shift/eoshift_s_wd1_5.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _EOSHIFT_JS5(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_LS5(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_SS5(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *
...
#pragma duplicate _EOSHIFT_JS5 as _EOSHIFT_LS5
#pragma duplicate _EOSHIFT_JS5 as _EOSHIFT_SS5
