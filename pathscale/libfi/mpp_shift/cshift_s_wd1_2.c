...
#pragma ident "@(#) libfi/mpp_shift/cshift_s_wd1_2.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _CSHIFT_JS2(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_LS2(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_SS2(RESULT, SOURCE, SHIFT, DIM)
 *
...
#pragma duplicate _CSHIFT_JS2 as _CSHIFT_LS2
#pragma duplicate _CSHIFT_JS2 as _CSHIFT_SS2
 ...
 */
	    ...
	    CSHIFT_WD1_S2@ ( result_base_ptr, source_sdd_ptr, shift_sdd_ptr,
