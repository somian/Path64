...
#pragma ident "@(#) libfi/mpp_shift/cshift_s_wd1_6.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _CSHIFT_JS6(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_LS6(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_SS6(RESULT, SOURCE, SHIFT, DIM)
 *
...
#pragma duplicate _CSHIFT_JS6 as _CSHIFT_LS6
#pragma duplicate _CSHIFT_JS6 as _CSHIFT_SS6
 ...
 */
	    ...
	    CSHIFT_WD1_S6@ ( result_base_ptr, source_sdd_ptr, shift_sdd_ptr,
		&dim_val, src_extents, shft_extents,
		&shflag, &shftval);
	}
}
