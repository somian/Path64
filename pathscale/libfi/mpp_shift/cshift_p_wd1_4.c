...
#pragma ident "@(#) libfi/mpp_shift/cshift_p_wd1_4.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _CSHIFT_JP4(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_LP4(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_SP4(RESULT, SOURCE, SHIFT, DIM)
 *
...
#pragma duplicate _CSHIFT_JP4 as _CSHIFT_LP4
#pragma duplicate _CSHIFT_JP4 as _CSHIFT_SP4
 ...
 */
	...
	CSHIFT_WD1_P4@ ( result_sdd_ptr, source_sdd_ptr, shift_sdd_ptr,
