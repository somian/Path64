...
#pragma ident "@(#) libfi/mpp_shift/cshift_s_wd1_4.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _CSHIFT_JS4(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_LS4(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_SS4(RESULT, SOURCE, SHIFT, DIM)
 *
...
#pragma duplicate _CSHIFT_JS4 as _CSHIFT_LS4
#pragma duplicate _CSHIFT_JS4 as _CSHIFT_SS4
 ...
 */
	    ...
	    CSHIFT_WD1_S4@ ( result_base_ptr, source_sdd_ptr, shift_sdd_ptr,
