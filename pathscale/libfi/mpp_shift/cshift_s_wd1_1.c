...
#pragma ident "@(#) libfi/mpp_shift/cshift_s_wd1_1.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _CSHIFT_JS1(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_LS1(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_SS1(RESULT, SOURCE, SHIFT, DIM)
 *
...
#pragma duplicate _CSHIFT_JS1 as _CSHIFT_LS1
#pragma duplicate _CSHIFT_JS1 as _CSHIFT_SS1
 ...
 */
	    ...
	    CSHIFT_WD1_S1@ ( result_base_ptr, source_sdd_ptr, src_extents,
		&shftval);
	}
}
