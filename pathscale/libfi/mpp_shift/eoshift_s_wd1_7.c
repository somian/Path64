...
#pragma ident "@(#) libfi/mpp_shift/eoshift_s_wd1_7.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _EOSHIFT_JS7(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_LS7(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_SS7(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *
...
#pragma duplicate _EOSHIFT_JS7 as _EOSHIFT_LS7
#pragma duplicate _EOSHIFT_JS7 as _EOSHIFT_SS7
 ...
 */
	    ...
	    EOSHIFT_WD1_S7@ ( result_base_ptr, source_sdd_ptr, shift_sdd_ptr,
