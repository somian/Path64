...
#pragma ident "@(#) libfi/mpp_shift/cshift_s_wd1_5.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _CSHIFT_JS5(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_LS5(RESULT, SOURCE, SHIFT, DIM)
 *		CALL _CSHIFT_SS5(RESULT, SOURCE, SHIFT, DIM)
 *
...
#pragma duplicate _CSHIFT_JS5 as _CSHIFT_LS5
#pragma duplicate _CSHIFT_JS5 as _CSHIFT_SS5
 ...
 */
	    ...
	    CSHIFT_WD1_S5@ ( result_base_ptr, source_sdd_ptr, shift_sdd_ptr,
