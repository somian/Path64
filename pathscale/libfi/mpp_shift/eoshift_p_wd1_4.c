...
#pragma ident "@(#) libfi/mpp_shift/eoshift_p_wd1_4.c	92.1	07/13/99 10:44:06"
 ...
 *		CALL _EOSHIFT_JP4(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_LP4(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *		CALL _EOSHIFT_SP4(RESULT, SOURCE, SHIFT, BOUNDARY, DIM)
 *
...
#pragma duplicate _EOSHIFT_JP4 as _EOSHIFT_LP4
#pragma duplicate _EOSHIFT_JP4 as _EOSHIFT_SP4
 ...
 */
	...
	EOSHIFT_WD1_P4@ ( result_sdd_ptr, source_sdd_ptr, shift_sdd_ptr,
