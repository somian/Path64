...
extern void __vcosf( float *x, float *y, long count, long stridex,
  long stridey );
#pragma weak vcosf
void vcosf( float *x, float *y, long count, long stridex, long stridey ) {
  __vcosf(x, y, count, stridex, stridey);
}
